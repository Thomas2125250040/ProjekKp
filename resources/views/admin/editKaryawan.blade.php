                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('karyawan.update', $karyawan->id_karyawan) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="kode_karyawan" name="kode_karyawan" required value="{{ $karyawan->kode_karyawan }}">
                            @error('kode_karyawan')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="nama_karyawan" name="nama_karyawan" required value="{{ $karyawan->nama_karyawan }}">
                            @error('nama_karyawan')
                            <label for="kode" class="text-danger">Kode karyawan sudah terdaftar. Silahkan ganti yang lain !</label>
                        @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" class="form-control" id="email" name="email" required value="{{ $karyawan->email }}">
                            @error('email')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" class="form-control" id="password" name="password" required value="{{ $karyawan->password }}">
                            @error('password')
                            <label for="kode" class="text-danger">Kode karyawan sudah terdaftar. Silahkan ganti yang lain !</label>
                        @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" required value="{{ $karyawan->tempat_lahir }}">
                            @error('tempat_lahir')
                            <label for="kode" class="text-danger">Kode karyawan sudah terdaftar. Silahkan ganti yang lain !</label>
                        @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" required value="{{ $karyawan->tanggal_lahir }}">
                            @error('tanggal_lahir')
                            <label for="kode" class="text-danger">Kode karyawan sudah terdaftar. Silahkan ganti yang lain !</label>
                        @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="nomor_telepon" name="nomor_telepon" required value="{{ $karyawan->nomor_telepon }}">
                            @error('nomor_telepon')
                            <label for="kode" class="text-danger">Kode karyawan sudah terdaftar. Silahkan ganti yang lain !</label>
                        @enderror
                        </div>
